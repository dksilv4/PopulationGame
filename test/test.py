...
class Test(unittest.TestCase):
    ...
    def testInputValidation(self):
        ...
        try:
            if table[1][0] == 2 and table[1][1] == "Diogo":
                ...
                print('\n' + self.testInputValidation.__name__.upper())
                self.register.inputValidation('Diogo', 'da Silva', 'dksilva', 'd@d.com', 'd@d.com', 'Password1', 'Password1')
                print(self.db.outputTable('users'))
    ...
    def testGetUserInfo(self):
        data = self.db.getUserInfo('name')
        self.assertEqual(data[0][0],'Diogo')
        self.assertEqual(data[0][1], 'da Silva')
    ...
    def testGiveFeedback(self):
        self.assertEqual(self.login.giveFeedback(True), 'Welcome Diogo da Silva!')
